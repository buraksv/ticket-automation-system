...
internal sealed class TicketPurchaseOrderAccountUpdateValidator : AbstractValidator<TicketPurchaseOrderAccountUpdateRequestDto>
{
    public TicketPurchaseOrderAccountUpdateValidator()
    {
