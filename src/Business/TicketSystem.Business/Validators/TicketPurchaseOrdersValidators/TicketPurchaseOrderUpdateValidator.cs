...
internal sealed class TicketPurchaseOrderUpdateValidator : AbstractValidator<TicketPurchaseOrderUpdateRequestDto>
{
    public TicketPurchaseOrderUpdateValidator()
    { 
