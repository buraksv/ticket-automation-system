...
internal sealed class TicketPurchaseCompletedOrderPagedListValidator : AbstractValidator<TicketPurchaseCompletedOrderSearchRequestDto>
{
    public TicketPurchaseCompletedOrderPagedListValidator()
    {
