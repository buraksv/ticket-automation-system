...
public interface ITicketProviderSettingsManager : IBusinessEngine
{
    ...
    ValueTask<Dictionary<string, string>> GetProviderSettingsAsync(TicketProviderSettingGetByProviderRequestDto request, CancellationToken cancellationToken = new());
