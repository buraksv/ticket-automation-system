...
namespace TicketSystem.DataAccess.Context.Migrations.PostgreSql
{
    ...
    [Migration("20250722232156_TicketAccountInformationSettingsTableCreated")]
    partial class TicketAccountInformationSettingsTableCreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.AdminLogin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.EventLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<byte>("Type")
                        .HasColumnType("smallint")
                        .HasComment("1 - Information,2 - Warning,3 - Danger,4 - Success");
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.Team", b =>
                {
                    ...
                    b.Property<string>("TicketSystemId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketAccountDefinitionSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex(new[] { "TicketAccountDefinitionId", "Key" }, "idx_ticket_account_definition_settings_unique")
                        .IsUnique();

                    b.ToTable("TicketAccountDefinitionSettings", (string)null);
                });

            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketPlace", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
                    ...
                    b.ToTable("TicketPlaces", (string)null);
                });

            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketPlaceConfigurations", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
                    ...
                    b.Property<short>("TicketPlaceId")
                        .HasColumnType("smallint");

                    b.Property<byte>("TicketSystem")
                        .HasColumnType("smallint")
                        .HasComment("PassoLig,Biletix,BuBilet,BiletiniAl,TicketMaster");
                    ...
                    b.HasIndex("TicketPlaceId")
                        .IsUnique();

                    b.ToTable("TicketPlaceConfigurations", (string)null);
                });

            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketProviderSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex(new[] { "Provider", "Key" }, "idx_unique_provider_settings")
                        .IsUnique();

                    b.ToTable("TicketProviderSettings", (string)null);
                });
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketAccountDefinitionSetting", b =>
                {
                    b.HasOne("TicketSystem.DataAccess.Entity.TicketAccountDefinition", "TicketAccountDefinition")
                        .WithMany("TicketAccountDefinitionSettings")
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketPlaceConfigurations", b =>
                {
                    b.HasOne("TicketSystem.DataAccess.Entity.TicketPlace", null)
                        .WithOne("TicketPlaceConfigurations")
                        .HasForeignKey("TicketSystem.DataAccess.Entity.TicketPlaceConfigurations", "TicketPlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketPurchaseOrder", b =>
                {
                    ...
                    b.HasOne("TicketSystem.DataAccess.Entity.TicketPlace", "TicketPlace")
                        .WithMany()
                        .HasForeignKey("TicketPlaceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketAccountDefinition", b =>
                {
                    b.Navigation("TicketAccountDefinitionSettings");
                });

            modelBuilder.Entity("TicketSystem.DataAccess.Entity.TicketPlace", b =>
                {
                    b.Navigation("TicketPlaceConfigurations")
                        .IsRequired();
                });
